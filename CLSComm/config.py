...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mat', choices=["commformer", "commformer_dec"])
    ...
    parser.add_argument("--sup_con_loss_coef", type=float,
                        default=0.01, help='supcon loss coefficient (default: 0.1)')
    parser.add_argument("--sup_con_loss_temp", type=float,
                        default=0.1, help='supcon loss temp (default: 0.1)')
    ...
    parser.add_argument("--eval_interval", type=int, default=4, help="time duration between contiunous twice evaluation progress.")
