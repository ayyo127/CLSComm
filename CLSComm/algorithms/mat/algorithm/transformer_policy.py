import torch
import numpy as np
from commformer.utils.util import update_linear_schedule
from commformer.utils.util import get_shape_from_obs_space, get_shape_from_act_space
...
class TransformerPolicy:
    ...
    def evaluate_actions(self, cent_obs, obs, rnn_states_actor, rnn_states_critic, actions, masks,
        ...
        action_log_probs, values, entropy, msgs = self.transformer(cent_obs, obs, actions, available_actions, steps, total_step)
        ...
        return values, action_log_probs, entropy, msgs
